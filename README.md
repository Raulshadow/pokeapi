...
4. Criadas todas as telas desejadas, adicionar uma navegação no click das listas:
    ...
    3. Tela de Games:
        - Ao selecionar um game, exibir curiosidades e informações sobre o filme, visto que a api entrega informações em formato de URL, talvez não tenha tanta informação útil.
